...
const RegularAdUpdateProcessing = ({ allAdUpdateData, loading, error }) => {
  if (loading) {
    return (
      <Card className="p-6">
  ...
  if (!allAdUpdateData) {
    return (
      <Card className="p-6">
        <h3 className="text-base sm:text-lg font-semibold text-gray-900 mb-3 sm:mb-4">Regular Ad-Update Processing</h3>
        <div className="text-center py-6 sm:py-8">
          <Play className="h-8 w-8 sm:h-12 sm:w-12 text-gray-300 mx-auto mb-2 sm:mb-3" />
          <p className="text-gray-500 text-sm sm:text-base">No ad-update processing data available</p>
        </div>
      </Card>
    );
  }
    ...
    <div className="grid gap-4 sm:gap-6 grid-cols-1">
      <Card>
        ...
        {allJobs.length > 0 ? (
          ...
          <div className="text-center py-6 sm:py-8">
            <Play className="h-8 w-8 sm:h-12 sm:w-12 text-gray-300 mx-auto mb-2 sm:mb-3" />
            <p className="text-gray-500 text-sm sm:text-base">No regular ad-update processing jobs</p>
          </div>
        )}
      </Card>
    </div>
...
export default RegularAdUpdateProcessing;
