  ...
  try {
    ...
    if (result && result.results) {
      if (result.results.success_count !== undefined) {
        ...
        logger.info(
          `Using direct counts: added=${totalAdded}, failed=${totalErrors}, skipped=${duplicates}`
        );
        ...
        logger.info(
          `Using details counts: added=${totalAdded}, failed=${totalErrors}, skipped=${duplicates}`
        );
        ...
        logger.info(
          `Using array counts: added=${totalAdded}, failed=${totalErrors}, skipped=${duplicates}`
        );
      }
    }
    ...
    if (
      ...
      duplicates = details.skipped ? details.skipped.length : 0;
      logger.info(
        `Fallback using details: added=${totalAdded}, failed=${totalErrors}, skipped=${duplicates}`
      );
    }

    logger.info(
      `Final counts: totalAdded=${totalAdded}, totalErrors=${totalErrors}, duplicates=${duplicates}`
    );
