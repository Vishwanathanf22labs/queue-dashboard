...
async function addProxy(req, res) {
  try {
    ...
    const result = await proxyManagementService.addProxy(
      ip,
      port,
      country,
      username,
...
async function updateProxy(req, res) {
  try {
    ...
    const result = await proxyManagementService.updateProxy(
      proxyId,
      {
        namespace,
        userAgent,
...
async function removeProxy(req, res) {
  try {
    ...
    const result = await proxyManagementService.removeProxy(
      proxyId,
      req.environment
    );
...
async function getProxies(req, res) {
  try {
    ...
    const result = await proxyManagementService.getProxies(
      page,
      limit,
      filter,
      search,
...
async function updateProxyStatus(req, res) {
  try {
    ...
    const result = await proxyManagementService.updateProxyStatus(
      proxyId,
      isWorking,
      req.environment
    );
...
async function switchToNextWorkingProxy(req, res) {
  try {
    ...
    const result = await proxyManagementService.switchToNextWorkingProxy(
      failedProxyId
    );
...
async function markProxyAsFailed(req, res) {
  try {
    ...
    const result = await proxyManagementService.markProxyAsFailed(
      proxyId,
      reason
    );
    res.status(200).json(result);
...
async function lockProxy(req, res) {
  try {
    ...
    const result = await proxyManagementService.lockProxy(
      proxyId,
      identifier,
      namespace
    );
